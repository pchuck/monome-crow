...
--
--   (1) is a lead voice that has 30% probability of triggering notes
...
--
--   (2) is an auxiliary voice (bass line) that has a 60% chance of
...
public.add('probability_1', 0.3, { 0.0, 1.0 })
public.add('probability_2', 0.6, { 0.0, 1.0 })
